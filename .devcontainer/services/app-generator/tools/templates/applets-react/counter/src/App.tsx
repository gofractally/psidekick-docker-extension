...
const __service__(lowerCase)Service = new __service__Service()
...
function App() {
    ...
    useEffect(() => {
        initializeApplet(async () => {
            setOperations(__service__(lowerCase)Service.operations)
        });
        fetchCurrentUser()
    ...
    const pushAddNumber = async () => {
        ...
        await __service__(lowerCase)Service.addNum(num)
